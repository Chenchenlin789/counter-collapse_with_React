...
function App() {
  return (
    <div className="App">
      {/* <Collaps question={faq[0].question} answer={faq[0].answer}></Collaps>
      <Collaps question={faq[1].question} answer={faq[1].answer}></Collaps>
      <Collaps question={faq[2].question} answer={faq[2].answer}></Collaps>
      <Collaps question={faq[3].question} answer={faq[3].answer}></Collaps> */}
